...
class Zombie:
    ...
    def draw(self):
        ...
        draw_circle(self.x, self.y, int(7 * PIXEL_PER_METER), 0, 255, 0)
    ...
    def if_have_more_balls(self, other = common.boy):
    ...
    def build_behavior_tree(self):
        ...
        c2 = Condition('소년보다 공이 많은가?', self.if_have_more_balls, common.boy)
        ...
        chase_boy_if_have_more_balls = Selector('소년 추적 또는 도망', chase_boy, a6)

        find_boy = Sequence('소년 발견', c1, chase_boy_if_have_more_balls)
        root = Selector('소년 발견 또는 배회', find_boy, wander)
